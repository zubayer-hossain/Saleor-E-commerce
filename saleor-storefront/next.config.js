...
const config = {
	...
	images: {
		// In dev, skip the image optimizer so `<Image src="http://localhost:8000/...">` works when
		// Next runs in Docker: optimizer runs in-container where `localhost` is not Saleor Core.
